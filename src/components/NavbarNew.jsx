        ...
        <div>
            <nav className="bg-[#1E1E1E] w-full h-[68px] flex items-center px-6 md:px-20 pb-36 md:pb-0 nav relative">
                <section className="max-w-[1700px] mx-auto hidden xl:flex justify-between items-center w-full ">
                    ...
                    <ul className="flex items-center gap-[15px] text-[18px] cursor-pointer font-semibold text-[#FFFFFF]">
                ...
                <section className="w-full xl:hidden relative">
                    <div className="flex items-center justify-between w-full">
                        <div
                            className="text-white text-[46px] cursor-pointer z-30"
                    ...
                    {menuOpen && (
                        <div className="absolute top-full left-0 w-full bg-white text-black p-4 px-4 md:px-12 z-20 max-h-[80vh] overflow-y-auto">
