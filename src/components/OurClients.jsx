  ...
  return (
    <>
      <div className="homeImg1">
        <div className="w-full h-auto max-w-[1700px] mx-auto pt-3 pb-24 ">
          ...
          <p className="text-[24px] bg-[#ceff2a] rounded-full px-6 m-auto w-fit sm:text-[32px] lg:text-[18px] font-semibold text-black leading-snug lg:leading-[3.5rem] mt-4 text-center">
            Chosen by Growth-Minded Leaders
          </p>
          ...
          <div className="w-full h-auto flex justify-between flex-wrap px-7 md:px-19 pt-8 md:pt-13">
            {[
              ...
              <div
                key={index}
                className="w-full sm:w-[48%]  lg:w-[23%] h-[143px] bg-[#DCD5F5]/40 rounded-[5px] flex items-center justify-center mt-8"
              >
                <img
                  src={logo}
                  alt={`client-${index + 1}`}
